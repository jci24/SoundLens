...
![SoundLens workflow from audio import through A/B comparison, ROI selection, evidence inspection, playback, and report preview](docs/assets/soundlens-demo.gif)
