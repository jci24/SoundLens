...
- Activity is labelled as investigation activity, never reasoning or thoughts. The frontend renders backend-authored titles and summaries but receives no private chain-of-thought, prompts, tool arguments, raw tool results, or partial unvalidated answers.
