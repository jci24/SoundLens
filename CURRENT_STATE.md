...
- Substantial investigation-guidance turns may now carry a backend-validated, versioned preview plan. Plans are limited to currently available catalog capabilities and preserve ordered dependencies, required evidence, parameter policy, completion criteria, scope, cost class, and approval requirements. Ambiguous objectives return one clarification question and no plan; plans cannot execute or mutate the workspace.
